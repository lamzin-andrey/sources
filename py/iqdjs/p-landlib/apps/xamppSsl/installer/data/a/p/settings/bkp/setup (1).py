...
class LocalhostManager(Gtk.Window):
    def __init__(self):
        ...
        # 1.1 Поле "Имя сайта"
        site_name_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=10)
        site_name_label = Gtk.Label(label="Имя сайта")
        site_name_label.set_halign(Gtk.Align.START)
        site_name_label.set_size_request(120, -1)
        site_name_entry = Gtk.Entry()
        site_name_entry.set_size_request(198, 30)
        ...
        root_dir_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=10)
        root_dir_label = Gtk.Label(label="Корневая директория")
        root_dir_label.set_halign(Gtk.Align.START)
        root_dir_label.set_size_request(120, -1)
        root_dir_entry = Gtk.Entry()
        root_dir_entry.set_size_request(198, 30)
        ...
        add_button.set_size_request(82, 30)
        ...
        frame1_box.pack_start(button_box, False, False, 0)
        ...
        filter_label.set_size_request(120, -1)
        filter_entry = Gtk.Entry()
        filter_entry.set_size_request(268, 30)
        ...
        # 2.2 ListBox для списка сайтов (аналог select multiple)
        sites = [
